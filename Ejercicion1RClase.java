 ...
 * @author usuario
 */
public class Ejercicion1RClase {
    ...
    public static void main(String[] args) {
        ...
        Jugador player1 = new Jugador("emi");
        Jugador player2 = new Jugador("lalo");
        Jugador player3 = new Jugador("pepe");
        ...
        System.out.println("Posicion Actual: "+ra.getPosicionActual());
        
        eljuego.llenarJuego(listado, ra);
        
        System.out.println("El perdedor es: "+eljuego.laRonda());
        
        for (Jugador player : listado) 
